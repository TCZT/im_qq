...
public class FriendView extends JFrame implements ActionListener, MouseListener {
	...
	JButton jb;
	JButton gChat, pChat;
	ImageIcon group, friend;
	public static String beTalkedTo;
	...
	public FriendView() {
		...
		// 处理北边的东西（头像，昵称，签名）
		head = new JLabel(new ImageIcon("qqhead.jpg"));
		head.setBounds(10, 40, 50, 50);
		name = new JLabel(loginFrame.txtName.getText());
		name.setBounds(70, 42, 80, 20);
		name.setFont(new Font("微软雅黑", Font.BOLD, 16));
		name.setForeground(Color.black);
		sign = new JLabel(" 巴拉拉能量 呜呼啦呼 ");
		sign.setBounds(70, 70, 150, 20);
		sign.setForeground(Color.black);
		sign.setFont(new Font("微软雅黑", Font.PLAIN, 12));
		friend = new ImageIcon("friend.png");
		group = new ImageIcon("group.png");
		pChat = new JButton(friend);
		pChat.setBounds(0, 175, 140, 30);
		gChat = new JButton(group);
		gChat.setBounds(140, 175, 140, 30);
	...
	public void firstCard() {
		...
		jp1_jb1.setFont(new Font("微软雅黑", Font.PLAIN, 12));
		...
		jp1_jb2.setFont(new Font("微软雅黑", Font.PLAIN, 12));
		...
		jp1_jb3 = new JButton("> 在线用户");
		jp1_jb3.setFont(new Font("微软雅黑", Font.PLAIN, 12));
	...
	public void secondCard() {
		...
		jp2_jb1.setFont(new Font("微软雅黑", Font.BOLD, 12));
		...
		jp2_jb2.setFont(new Font("微软雅黑", Font.PLAIN, 12));
		...
		{
			jbls[i] = new JLabel(i + 1 + "", new ImageIcon("qqhead.jpg"), JLabel.LEFT);
	...
	public void thirdCard() {
		...
		jp3_jb1.setFont(new Font("微软雅黑", Font.PLAIN, 12));
		...
		jp3_jb2.setFont(new Font("微软雅黑", Font.BOLD, 12));
		...
		jp3_jb3 = new JButton("∨ 在线用户");
		jp3_jb3.setFont(new Font("微软雅黑", Font.BOLD, 12));
		...
		for (int i = 0; i < jbls.length; i++) {
			jbls[i] = new JLabel(i + "", new ImageIcon("qqhead.jpg"), JLabel.LEFT);
			jbls[i].addMouseListener(this);
			jp_jsp2.add(jbls[i]);
		}
	...
	public void fourthCard() {
		...
		jp4_jb1.setFont(new Font("微软雅黑", Font.PLAIN, 12));
		...
		jp4_jb2.setFont(new Font("微软雅黑", Font.PLAIN, 12));
		...
		jp4_jb3 = new JButton("∨ 在线用户");
		jp4_jb3.setFont(new Font("微软雅黑", Font.BOLD, 12));
		...
		// 初始化当前在线用户列表
		JLabel[] jbls = new JLabel[10];
		for (int i = 0; i < ServerProcess.onlineUser.size(); i++) 
		{
			onlineName = ServerProcess.onlineUser.elementAt(i).toString();
			System.out.println(onlineName+i);
			jbls[i] = new JLabel(onlineName, new ImageIcon("qqhead.jpg"), JLabel.LEFT);
			jbls[i].addMouseListener(this);
			jp_jsp3.add(jbls[i]);
		}
		System.out.println(onlineName+ServerProcess.onlineUser.size());
